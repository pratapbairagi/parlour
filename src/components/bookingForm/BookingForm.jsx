...
const BookingForm = ({ toggleForm, setToggleForm, bookingData }) => {
    ...
    return (
        <div className="container-fluid-fluid" style={{ display: `${toggleForm}`, flexDirection: "column", padding: "0 32px", alignItems: "center", justifyContent: "center", height: "100vh", width: "100%", left: "0", top: "0", position: "fixed", zIndex: "3", background: "rgba(0,0,0, .25)"}}>
            ...
            <button onClick={()=> toggleFormFunction()} className="btn m-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="rgb(215,4,115)" className="bi bi-x" viewBox="0 0 16 16">
            ...
            <div className="form-container row d-flex flex-wrap pt-3 pb-4 px-3 mx-auto" style={{ rowGap: "6px", width: "100%", boxShadow: " 0 0 0 2px gainsboro", borderRadius: "3px", background: "aliceblue", height: "max-content", maxWidth:"700px" }}>
                <h4 className="mb-2" style={{ width: "100%", textAlign: "center", color: "rgb(215,4,115)", fontWeight: "600", fontSize: "170%" }}>Booking Details</h4>
                    ...
                    <div className="input-group mx-auto" style={{ width: "98%", borderBottom: "1px solid grey" }} >
                        <div className="input-group-prepend" style={{ border: "none" }}>
                            <label className="input-group-text rounded-0" id="basic-addon1" style={{ background: "transparent", border: "none" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" fill="rgb(215,4,115)" className="bi bi-person-fill-exclamation" viewBox="0 0 16 16">
                ...
                <div className="col col-12 col-md-6 col-lg-6 col-xl-6 p-0">
                    <div className="input-group mx-auto" style={{ width: "98%", borderBottom: "1px solid grey" }} >
                        <div className="input-group-prepend">
                            <label className="input-group-text rounded-0" id="basic-addon1" style={{ background: "transparent", border: "none" }} >
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" fill="rgb(215,4,115)" className="bi bi-telephone-fill" viewBox="0 0 16 16">
                ...
                <div className="col col-12 col-md-6 col-lg-6 col-xl-6 p-0">
                    <div className="input-group mx-auto" style={{ width: "98%", borderBottom: "1px solid grey" }} >
                        <div className="input-group-prepend">
                            <label className="input-group-text rounded-0" id="basic-addon1" style={{ background: "transparent", border: "none" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" fill="rgb(215,4,115)" className="bi bi-envelope-at-fill" viewBox="0 0 16 16">
                    ...
                    <div className="input-group mx-auto" style={{ width: "98%", borderBottom: "1px solid grey" }} >
                        <div className="input-group-prepend">
                            <span className="input-group-text rounded-0" id="basic-addon1" style={{ background: "transparent", border: "none" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" fill="rgb(215,4,115)" className="bi bi-house-exclamation-fill" viewBox="0 0 16 16">
                ...
                <div className="col col-12 col-md-6 col-lg-6 col-xl-6 p-0">
                    <div className="input-group mx-auto" style={{ width: "98%", borderBottom: "1px solid grey" }} >
                        <div className="input-group-prepend">
                            <span className="input-group-text rounded-0" id="basic-addon1" style={{ background: "transparent", border: "none" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" fill="rgb(215,4,115)" className="bi bi-calendar2-date-fill" viewBox="0 0 16 16">
                    ...
                    <div className="input-group mx-auto" style={{ width: "98%", borderBottom: "1px solid grey" }}>
                        <div className="input-group-prepend">
                            <label htmlFor="" className="input-group-text rounded-0" style={{ background: "transparent", border: "none" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" fill="rgb(215,4,115)" className="bi bi-calendar2-heart-fill" viewBox="0 0 16 16">
                ...
                <button className="btn mt-2 mx-auto" onClick={submitForm} style={{ width: "99%", fontWeight: "600", letterSpacing: "1px", background: "rgb(215,4,115)", color: "white", fontSize: "130%" }}>Book</button>
            </div>
