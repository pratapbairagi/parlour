                ...
                <div className="col col-12 col-md-10 col-lg-5 col-xl-4 p-3" style={{ background: "aliceblue", boxShadow: "0 0 2px grey", aspectRatio:"1/.9" }}>
                    ...
                    <ol className="mt-2" style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
                        <li style={{ display: "flex", flexDirection: "row", gap: "4px", alignItems: "center", width: "max-content", padding: "3px 9px", border: "2px solid rgb(215, 4, 115)", borderRadius: "3px" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="rgb(215, 4, 115)" className="bi bi-calendar-date" viewBox="0 0 16 16">
                            ...
                            <span style={{ fontSize: "70%", color: "rgb(215, 4, 115)", fontWeight: "600" }}>Book your day</span>
                        </li>

                        <li style={{ display: "flex", flexDirection: "row", gap: "4px", alignItems: "center", width: "max-content", padding: "3px 9px", border: "2px solid rgb(215, 4, 115)", borderRadius: "3px" }}>
                            <img src="images/ayurvedic-bowl-svgrepo-com.svg" style={{ width: "24px", height: "24px" }} alt="" />
                            <span style={{ fontSize: "70%", color: "rgb(215, 4, 115)", fontWeight: "600" }}>Herbal Products</span>
                        </li>

                        <li style={{ display: "flex", flexDirection: "row", gap: "4px", alignItems: "center", width: "max-content", padding: "3px 9px", border: "2px solid rgb(215, 4, 115)", borderRadius: "3px" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="rgb(215, 4, 115)" className="bi bi-clock" viewBox="0 0 16 16">
                                <path d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71V3.5z" />
                                <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm7-8A7 7 0 1 1 1 8a7 7 0 0 1 14 0z" />
                            </svg>
                            <span style={{ fontSize: "70%", color: "rgb(215, 4, 115)", fontWeight: "600" }}>10 hrs service</span>
                        </li>

                        <li style={{ display: "flex", flexDirection: "row", gap: "4px", alignItems: "center", width: "max-content", padding: "3px 9px", border: "2px solid rgb(215, 4, 115)", borderRadius: "3px" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="rgb(215, 4, 115)" className="bi bi-currency-rupee" viewBox="0 0 16 16">
                                <path d="M4 3.06h2.726c1.22 0 2.12.575 2.325 1.724H4v1.051h5.051C8.855 7.001 8 7.558 6.788 7.558H4v1.317L8.437 14h2.11L6.095 8.884h.855c2.316-.018 3.465-1.476 3.688-3.049H12V4.784h-1.345c-.08-.778-.357-1.335-.793-1.732H12V2H4v1.06Z" />
                            </svg>
                            <span style={{ fontSize: "70%", color: "rgb(215, 4, 115)", fontWeight: "600" }}>Minmum Charge</span>
                        </li>
                    </ol>
                </div>
