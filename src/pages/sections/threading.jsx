...
// const Threading = ({id, data}) =>{
//     return(
//         <div id={id} className="container-fluid faceSection_container" style={{padding:"8px 0 32px 0"}}>
//             <h3 className="mt-5" style={{width:"100%", boxShadow:"0 0 2px grey", padding:"6px 16px", color:"pink", borderRadius:"4px 15px 4px 15px", fontWeight:"600", letterSpacing:"1px"}}>Threading</h3>
//             {data.map((v,i)=>{
//            return <div key={i} className="row d-flex flex-wrap mt-1" style={{background:"whitesmoke", padding:"42px 4px", display:"flex", justifyContent:"center"}}>
...
//                         <h4 className="" style={{width:"max-content", color:"white", letterSpacing:"1px", maxWidth:"max-content", padding:"2px 8px", alignSelf:"end", fontSize:"170%", fontWeight:"600", borderRight:"2px solid red"}}>Eyebrow Threading</h4>
...
//                         {v.use.map((use, index2)=>{
//                             return <li key={index2}>{use}</li>
//                         })}
...
//                             <span style={{color:"teal", fontSize:"120%", fontWeight:"600"}}>Charge Rs. {(v.charge.normal+v.home_Service
//                                 )}/-</span>
//                         </div>
...
//             {/* <div className="row d-flex flex-wrap mt-1" style={{background:"transparent", padding:"42px 4px", display:"flex", justifyContent:"center"}}>

//                 <div className="col col-12 col-md-10 col-lg-6 col-xl-5">
//                    <div className="row d-flex flex-wrap mt-1" style={{ padding:"12px 4px", display:"flex", flexDirection:"column"}}>
                   
//                    <h4 className="" style={{width:"max-content", color:"grey", letterSpacing:"1px", maxWidth:"max-content", padding:"2px 8px", float:"left", alignSelf:"start", fontSize:"170%", fontWeight:"600", borderLeft:"2px solid red"}}>Upper Lips Threading</h4>
...
//                 <div className="col col-12 col-md-10 col-lg-6 col-xl-5 p-2" style={{border:"2px solid pink"}}>
//                         <img src="images/upperLips_threading.jpeg" style={{width:"100%", aspectRaio:"1/1"}} alt="" />
//                 </div>
//             </div> */}
//         </div>
//     )
