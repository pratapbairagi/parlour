...
const Threading = ({id}) =>{
    return(
        <div id={id} className="container-fluid faceSection_container" style={{padding:"8px 0 32px 0"}}>
            ...
            <div className="row d-flex flex-wrap mt-1" style={{background:"whitesmoke", padding:"42px 4px", display:"flex", justifyContent:"center"}}>
                <div className="col col-12 col-md-10 col-lg-6 col-xl-5 p-2" style={{border:"2px solid pink"}}>
                        <img src="images/eyebrow_threading.jpeg" style={{width:"100%", aspectRaio:"1/1"}} alt="" />
                </div>
