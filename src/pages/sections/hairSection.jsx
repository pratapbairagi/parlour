...
// const HairSection = ({id, data}) =>{

//     console.log(data)
//     return(
//         <div id={id} className="container-fluid faceSection_container" style={{padding:"8px 0 32px 0"}}>
//             <h3 className="mt-2" style={{width:"100%", boxShadow:"0 0 2px grey", padding:"6px 16px", color:"pink", borderRadius:"4px 15px 4px 15px", fontWeight:"600", letterSpacing:"1px"}}>Hair</h3>
...
//                         <h4 className="" style={{width:"max-content", color:"white", letterSpacing:"1px", maxWidth:"max-content", padding:"2px 8px", alignSelf:"end", fontSize:"170%", fontWeight:"600", borderRight:"2px solid red"}}>{v.title}</h4>
...
//                         {  v.ingredients.map((ingred, index)=>{ return <li key={index}>{ingred}</li> }) }
...
//                         <h4 className="" style={{width:"max-content", color:"grey", letterSpacing:"1px", maxWidth:"max-content", padding:"2px 8px", float:"left", fontSize:"170%", fontWeight:"600", borderLeft:"2px solid red"}}>Hair Straightening</h4>
...
//                 <div className="col col-12 col-md-10 col-lg-6 col-xl-5 p-2" style={{border:"2px solid pink"}}>
//                         <img src="images/hairStraightning.jpeg" style={{width:"100%", aspectRaio:"1/1"}} alt="" />
//                 </div>
//             </div> */}
//         </div>
//     )
